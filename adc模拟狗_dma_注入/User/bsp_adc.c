...
void ADC1_Config(void)
{
	...
	ADC_AnalogWatchdogSingleChannelConfig(ADC1,ADC_Channel_2);//哪一个通道
	ADC_AnalogWatchdogThresholdsConfig(ADC1,4000,1500);//上限3.22V  下限 1.20V
	ADC_AnalogWatchdogCmd(ADC1,ADC_AnalogWatchdog_SingleRegEnable);//使能什么规则通道或注入通道 单个或全部
